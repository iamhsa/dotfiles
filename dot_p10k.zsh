# Generated by Powerlevel10k configuration wizard on 2021-11-23 at 22:37 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_TERRAFORM_PROMPT_ALWAYS_SHOW=true
  typeset -g POWERLEVEL9K_ASDF_PACKER_PROMPT_ALWAYS_SHOW=true
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|packer|ssm-session|ssm-tunnel|ssm-ssh'
